...
public class VentaRepository {
    ...
    public Venta create(String fecha,int usuario_id,int cliente_id,int forma_pago_id)throws SQLException{
       ...
       Venta creada = new Venta(id,fecha,usuario_id,cliente_id,forma_pago_id);
       return creada;
    }
